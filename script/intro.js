...
$.Intro.prototype.activate = function() {
	$.camera.locate(new THREE.Vector3(0, 0, 0), new THREE.Vector2(1, 0), $.camera.computeDistance(80, 40), 0);
...
$.Intro.prototype.load = function() {
	...
	this.playButtonObject.startPosition = new THREE.Vector3(100, -5, -7);
	this.playButtonObject.showPosition = new THREE.Vector3(0, -5, -7);
